export const renderCourseware = (contentHtml) => {
  ...
  // const payload = {
  //   stepId:"6448d5b4380d26ccc9923e35",
  //   problemId:"63f49c04456abec2d7baddf5",
  //   dataOptionId:[],
  //   isSkip:true,
  //   dataOptionText: [],
  //   studentDoRight: null,
  //   textAnswer:""
  // }
  // const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..scZt4GXtas2M6ubEWfP8gpMo_N5ZxPu9boP7W1D15H0";
  
  // let response = await fetch('https://api-elb.onluyen.vn/api/practice/questions/sendanswer',{
  //   method:'post',
  //   headers:{
...
import getQuestion from "./screens/ToDo/School/ToDo/Redux/reducers/getQuestion";
...
export const { getQuestionRequest, getQuestionSuccess, getQuestionFailure } = counterSlice.actions
...
function* getQuestionSaga(action) {
  try {
    ...
    if(question.status == 200){
      return yield put(getQuestionSuccess(question));
    }
    throw new Error(question.message || "dsadsa");
  } catch (e) {
    console.log(e);
    yield put(getQuestionFailure(e.message));
  }
}

function* practiceSaga() {
  yield takeEvery(getQuestionRequest.type.toString(), getQuestionSaga);
